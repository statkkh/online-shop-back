...
@Getter
public class PostBuyProductResponseDto extends ResponseDto{
    
    private PostBuyProductResponseDto(String code, String messsage){
        super(code, messsage);
    }

    public static ResponseEntity<PostBuyProductResponseDto> success(){
        PostBuyProductResponseDto result = new PostBuyProductResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
